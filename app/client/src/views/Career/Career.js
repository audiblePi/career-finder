    ...
    return (
        <div>
            ...
            <div className={classes.buttongroup}>
                <Button variant="contained" color="primary" href={"/Career/" + id + "/DITL/"}>
                    A Day in the Life
                </Button>
                <ButtonGroup
                ...
                >
                    <Button color="primary" href={"/Career/" + id + "/Celebrity/1"}>Celebrity Link 1</Button>
                    <Button color="primary" href={"/Career/" + id + "/Celebrity/2"}>Celebrity Link 2</Button>
                    <Button color="primary" href={"/Career/" + id + "/Celebrity/3"}>Celebrity Link 3</Button>
                </ButtonGroup>
            </div>
        </div>
    );
